...
const unitDefs = {
  ...
  Paladin:   { hp: 8, range: 1, dmg: 3, symbol: "🛡️", move: 2, ability: "Smite distant foe", rangePattern: "orthogonal", movePattern: "orthogonal", cost: 5 },
  ...
  Builder:   { hp: 5, range: 1, dmg: 1, symbol: "🛠️", move: 2, ability: "Construct or clear terrain", rangePattern: "orthogonal", movePattern: "orthogonal", cost: 3 },
};
