(function() {
  window.RuneDefs = [
    { id: "rune_hp", name: "Vitality I", desc: "+2 Max HP", cost: 2, apply: (u) => { u.maxHp += 1; u.hp += 1; } }, 
    { id: "rune_dmg", name: "Power I", desc: "+2 Damage", cost: 2, apply: (u) => { u.dmg += 2; } },
    { id: "rune_move", name: "Swiftness I", desc: "+1 Move", cost: 3, apply: (u) => { u.move += 1; } },
    { id: "rune_range", name: "Scope I", desc: "+1 Range", cost: 3, apply: (u) => { u.range += 1; } },
    { id: "rune_ap", name: "Frenzy I", desc: "+1 Max AP", cost: 4, apply: (u) => { u.apMax += 1; u.ap += 1; } },
